...
format: 
  revealjs: 
    ...
    footer: "spatialsample: A tidy approach to spatial cross-validation - https://mm218.dev/ehadec2023"
---
...
- These slides: [mm218.dev/ehadec2023](https://mm218.dev/ehadec2023)

- Package: [https://github.com/tidymodels/spatialsample](https://github.com/tidymodels/spatialsample)
...
![](crp.png){.quarto-figure-centered}
...
{{< fa square-check >}} All methods implemented in spatialsample itself

{{< fa square-check >}} C++ implementation of most computationally-intensive parts
...
![](ploton.png){.quarto-figure-center}

---

## Should we be doing this at all?

![](wadoux.png){.quarto-figure-center}

## Should we be doing this at all?

![](mila.png){.quarto-figure-center}

## Should we be doing this at all?

![](mee313851-fig-0004-m.jpg){.quarto-figure-center}
...
{{< fa square-check >}} When extrapolating into new regions

{{< fa square-check >}} When working with clustered or convenience samples

{{< fa square-xmark >}} When interpolating within the sampled area

{{< fa square-xmark >}} When an independent probability sample exists
...
Slides available at [mm218.dev/ehadec2023](https://mm218.dev/ehadec2023)
